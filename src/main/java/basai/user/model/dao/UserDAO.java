...
//            System.out.println("Connected to database for loginUser");
//            System.out.println("Email: "+ email + "Password: " + password);
    ...
    public ArrayList<User> getUsersByRole(String role) {
        ArrayList<User> users = new ArrayList<>();
        String sql = "SELECT * FROM users WHERE role = ?";  // parameterized, safe from SQL injection
    ...
    public User getUserById(int user_id) {
        String sql = "SELECT * FROM users WHERE user_id = ?";  // parameterized, safe from SQL injection
